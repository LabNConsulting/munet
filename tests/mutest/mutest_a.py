...
from munet.mutest.userapi import step, match_step, wait_step, TestCase
...
wait_step("r1", "sleep .2 && ls -l /dev/tty", "crw.* /dev/tty", "Look for /dev/tty", 1, False)
wait_step("r1", "sleep .5 && ls -l /dev/tty", "crw.* /dev/tty", "Look for /dev/tty", 1, .25)
wait_step("r1", "sleep .2 && ls -l /dev/tty", "crw.* /dev/tty", "Look for /dev/tty", 1,
          expect_fail=False)
wait_step("r1", "sleep .5 && ls -l /dev/tty", "crw.* /dev/tty", "Look for /dev/tty", 1, .25, False)
wait_step("r1", "sleep .5 && ls -l /dev/tty", "crw.* /dev/tty", "Look for /dev/tty", 1, .25,
          expect_fail=False)
...
wait_step("host1", "ls -l /", " nodir", "Look for no /nodir", 1, interval=.25,
          expect_fail=True)
wait_step("host1", "ls -l /", " nodir", "Look for no /nodir", timeout=1,
          expect_fail=True)
wait_step("host1", "ls -l /", " nodir", "Look for no /nodir", timeout=1, interval=.25,
          expect_fail=True)
